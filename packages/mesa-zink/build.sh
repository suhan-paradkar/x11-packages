...
TERMUX_PKG_DEPENDS="libandroid-shmem, libxxf86vm, libxxf86dga, bison, flex, libexpat, libdrm, libx11, libxdamage, libxext, zstd, libxml2, libxshmfence, zlib, vulkan-headers, vulkan-loader-android"
